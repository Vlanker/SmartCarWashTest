...
namespace SmartCarWashTest.Sale.WebApi.DTOs.Events
{
    ...
    public record InternalSalesDataPublishedIntegrationEvent(int ProductId, int ProductQuantity, int ProductIdAmount)
        : IntegrationEvent
    {
        public InternalSalesDataPublishedIntegrationEvent() : this(default, default, default)
        {
        }
    }
}