...
namespace SmartCarWashTest.CRUD.WebApi.Repositories.Repositories.Base
{
    public abstract class BaseCacheRepository<TCreateDto, TReadDto, TUpdateDto, TEntity> :
        ...
        where TEntity : class, Common.EntityModels.Sqlite.Abstractions.IHaveIdentifier
    {
        ...
        {
            _smartCarWashContext = smartCarWashContext ?? throw new ArgumentNullException(nameof(smartCarWashContext));
