...
using SmartCarWashTest.EventBus.Extensions;
...
namespace SmartCarWashTest.EventBusRabbitMq.EventBuses
{
    ...
    public class EventBusRabbitMq : IEventBus, IDisposable
    {
        ...
        /// Broker name.
        /// </summary>
        private const string BrokerName = "smartcarwashtest_event_bus";
        ...
        /// <summary>
        /// EventBus to RabbitMQ.
        /// </summary>
        /// <param name="persistentConnection"> RabbitMQ persistent connection. </param>
        /// <param name="logger"> <see cref="ILogger"/>. </param>
        /// <param name="serviceProvider"> <see cref="IServiceProvider"/>, </param>
        /// <param name="subsManager"> EventBus subscriptions manager. </param>
        ...
        /// </summary>
        /// <returns> Consumer channel. </returns>
                ...
                foreach (var subscription in subscriptions)
                {
                    if (subscription.IsDynamic)
                    {
                        if (scope.ServiceProvider.GetRequiredService(subscription.HandlerType)
                            is not IDynamicIntegrationEventHandler handler)
                        {
                            continue;
                        }
